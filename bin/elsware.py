...
parser.add_option(dictopt.DictOption("-p","--passwords",action="dic",type="string",dest="passwords",help="Passwords for the 'password_in_opt' parameters. See elsware.core.dictopt.DictOption for examples."))
